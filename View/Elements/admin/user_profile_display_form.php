...
?>
<style type="text/css">
	#UserProfileDisplayTable table td {
		text-align: left;
	}
</style>
...
$(function () {
	$('#UserProfileDisplayTable').insertBefore('#BtnSave');
...
<div id="UserProfileDisplayTable">
	<div class="section">
			...
			<tr>
				...
				<td class="col-input" colspan="3">
					...
					<span id="PreviewUserProfileDisplayGravatar" class="display-none">
						...
						<br /><small>Gravatarに登録しているメールアドレスを入力してください。設定すると画像が表示されます。</small>
					</span>
				</td>
			</tr>
